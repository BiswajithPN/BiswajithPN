...
> ℹ️ **Why this changed:** the old stats/top-languages/trophy badges pulled from the shared public `github-readme-stats.vercel.app` instance, which has been unstable and partly shut down since late 2025 — that's why they showed up broken. The card above is generated by a GitHub Action straight into your own repo, so it isn't affected by that outage and won't randomly break again. Setup is below.
...
> ℹ️ **Setup note:** The snake animation is generated by a GitHub Action, not a static image — it needs a one-time setup in your repo (steps below).
